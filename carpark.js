...
var Carpark = function(x, y, width, length){
	this.x = x || 0;
	this.y = y || 0;
...
Carpark.prototype.condition = function(){
	if(this.rotation === 0){
...
Carpark.prototype.clicked = function(){
		if(this.condition()){
...
Carpark.prototype.cursor = function(){
	if(this.condition()){
		cursor(MOVE);
	}
	else{
...
Carpark.prototype.rotate = function(){
